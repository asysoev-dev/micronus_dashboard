    ...
    <div class="grid grid-auto-flow lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        >
            <div class="mb-4 flex justify-between relative">
                ...
                <EllipsisVertical
                    class="h-8 w-8 py-1 cursor-pointer hover:stroke-slate-500 active:stroke-slate-500 transition-all duration-200 ease-in-out"
        ...
        <div
            :class="`w-full bg-brand-900 p-4 rounded-xl flex flex-col justify-center items-center opacity-75 cursor-pointer hover:bg-gray-600 active:bg-gray-600 transition-all duration-200 ease-in-out shadow-sm/30`"
            @click="addNewDevise"
        >
